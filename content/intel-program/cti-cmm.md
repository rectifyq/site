---
title: "CTI-CMM Self-Assessment"
description: "Rectifyq scored honestly against the community CTI Capability Maturity Model — published yearly, gaps included — plus how Malaysian organizations can use Rectifyq to raise their own scores."
date: 2026-07-17
tags: [intel-program, cti-cmm]
---

[CTI-CMM](https://cti-cmm.org) is the community-driven, vendor-neutral maturity model for CTI programs — built by 30+ practitioners, aligned with the C2M2's stakeholder domains, and use-case-driven rather than checkbox-driven. Version 1.2 spans **11 stakeholder domains** with maturity levels **CTI0 (pre-foundational) → CTI3 (leading)**.
...
<!-- VERIFY against CTI-CMM v1.2 domain names/worksheet before publishing; re-score yearly —
     the year-over-year delta becomes recurring content. -->
