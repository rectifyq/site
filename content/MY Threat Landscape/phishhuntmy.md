...
1. **Identify**: Find an active phishing link or campaign (SMS, Email, Social Media) specifically targeting Malaysians. 
2. **Analyze**: Break down the infrastructure and TTP used by Threat Actor. Who is the registrar? Where is it hosted? Can you find the phishing kit etc? (Always use a sandbox/VM).
3. **Report & Post**: File a report with Google Safe Browsing or MyCERT (Cyber999) or any relevant parties. Then, share your findings on LinkedIn, X, Facebook, or your blog to educate others.
4. **Submit**: Drop your analysis and post link in our entry form: [https://forms.gle/ei6EqfBFsbtzdEJU9] before 12 midnight of 15th March 2026
🏆 The Prizes (Touch 'n Go e-Wallet Credit: Each category will win RM100)
...
- **The Community Advocate (Engagement Prize)**: For the Rectifyq's Linkedin repost (once you submitted your entry, we will repost it in our page) that gets the most Likes & Shares. This is about making the warning go viral to prevent others from falling victim. 
Counting date fort his prize will be on 12 noon of 18th March 2026. Do share with everyone your specific Rectifyq's Linkedin repost for everyone to like and share.
...
|---|---|---|---|---|
|[ayiezola](https://ayiezola.github.io/2026-03-09-Phishing-Page-Semakan-Tunai-Rahmah/)|Working Professional|26|Infection chain using AI/clean diagram, nuclei template, comparative analysis, sample of exfiltrated data|No Recommendation included, TTPs listed not using known framework such as MITRE ATT&CK|
|[nazif](https://www.notion.so/How-Scammers-Stole-Telegram-Accounts-During-Ramadhan-2026-3211ea45347c80f19a61cbb0f570fc64)|Working Professional|26|Included Impact assessment and usage of PCAP analysis|No infection chain diagram included & report format to be more concise and succinct|
|[171k](https://171k.my/2026/03/10/tngmadaniphishing/)|Student|25|Included TA assessment and TA's opsec fails|No Action taken (e.g. report to google safe browsing) included, TTPs listed not using known framework such as MITRE ATT&CK|
|[Myo](https://myos-esc.gitbook.io/myos-esc./blogs/phishing-campaign-analysis-laptop-percuma-bantuan-e-wallet-scam)|Student|23|None|Action taken (e.g. report to google safe browsing) can be beyond the two listed in the google form|
|[Alif & Faez](https://remarkable-xenon-ff5.notion.site/TNG-eWallet-Quishing-Campaign-31ea6f58415f80cc8e2dd5cee0c56826)|Student|22|Included Chain of Code Reuse|TTPs listed not using known framework such as MITRE ATT&CK|

### Remaining 6 (listed in random and no particular order)

|Article link|Category|Extra points given|Room for improvement|
|---|---|---|---|
|[n3r](https://badrulmunir.com/posts/fake-ewallet-my/)|Working Professional|OTP Form & Anti analysis|To include executive summary, to include action taken|
|[khairul-zuhaili](https://www.linkedin.com/posts/khairul-zuhaili-4abb2435a_initial-discovery-a-suspicious-activity-7438077834687881216-5pHw)|Student|Telegram bot screenshot with victim data|To include executive summary, IoCs and action taken|
|[akmaltaufik](https://medium.com/@work.akmaltaufik/hunting-a-touch-n-go-duit-raya-phishing-campaign-targeting-malaysians-dedad86d39b1)|Student|Usage of crt.sh for pivoting|To include executive summary, TTPs using known framework and action taken & report format to be more concise and succinct|
|[syazwanisubri](https://www.linkedin.com/posts/syazwanisubri_phishhuntmy-phishhuntmy-quishing-activity-7438584878696325120-YoYN)|Working Professional|Usage of VT collection|To include infection diagram/attack diagram and screenshots/proof of reporting to be included directly in the article (audience may missed to check in the evidence folder you've created)|
|[matpwnguin](https://shrouded-brake-a7f.notion.site/Bantuan-Laptop-eMadani-Phishing-Analysis-320002229ba780278300f55f5b06adb1)|Working Professional|Included TA assessment and security misconfig|Executive summary is a bit too long - can be more concise, to include action taken|
|[amirulhmd](https://www.linkedin.com/posts/amirulhmd_phishing-alert-think-before-you-scan-ugcPost-7438172372588924928-zlYa)|Student|Asked questions to stakeholder (Rectifyq) - which is good to understand stakeholder's requirement, reporting (action taken) beyond suggested (Cloudflare abuse)|Overview if chosen as executive summary is bit too long, TTPs listed not using known framework such as MITRE ATT&CK|


## Results for Community Advocate
[Winner: Alif & Faez](https://www.linkedin.com/feed/update/urn:li:activity:7438379392071839744/)
