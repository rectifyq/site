...
timeline
    ...
    2018 (1) : Med** Pri** Ber*** (Television Broadcast)
    2021 (5) : GDe****** Ber*** (Logistic)
    ...
    2022 (6) : Asi* Pac**** Uni******* Sdn* Bhd* (Academia - University)
    ...
    2023 (21) : Mat*** Edu**** Sdn Bhd* (Education)
    ...
    2024 (21) : Har****** Hol***** Ber*** (Manufacturing)
    ...
    2025 (38) : Mal**** Air**** Sdn Bhd* (Civil Aviation)
         : Kov** Sdn Bhd (eCommerce)
         : Rek*** Sdn* Bhd* (Technology)
